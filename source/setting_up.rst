...
После этого появится сообщение: «Трекер создан». Если зайти в настройки (три точки в верхнем углу), там появится сообщение: «Автоматически отправлять информацию об отслеживании в *адрес указанной Веб ГИС*», как показано на :numref:`synced_success_pic`.
